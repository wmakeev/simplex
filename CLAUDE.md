...
- After implementing a task from a TODO or REFACTORING file, mark it as done before committing. Also update line number references in remaining (uncompleted) tasks if they were affected by the changes.
